                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    if ($row['destaque'] == 'Sim') 
                                    {
                                        echo '<span class="glyphicon glyphicon-star text-warning ari-hidden="true"> </span>';
                                    }
                                    else
                                    {
                                        echo '<span class="glyphicon glyphicon-ok ari-hidden="true"> </span>';
                                    }
                                    echo '&nbsp;';
                                    echo $row['descricao'];
                                ?>
                            ...
                            <td>
                                <img src="../images/<?php echo $row['imagem']; ?>" width="90px">
                            </td>
                            <td>
                                <a 
